...
export class SecureComponent implements AfterViewInit, OnInit, OnDestroy {
    ...
    public constructor(private _router: RouterExtensions, private _activatedRoute: ActivatedRoute, private cdRef: ChangeDetectorRef, private _bdUserService: BundledocsUserService, private _ngZone: NgZone) {
